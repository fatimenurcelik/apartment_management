     ...
     <div class="container d-flex justify-content-around">
        <div class="row ">
             <div class="col md-flex">
                <div class="card2">
                    <a href="member.php" >
                    <img src="images/yenüye.png" class="card-img-top img-thumb-nail " id="photo" alt="">
                    </a>
                    <div class="card-body">
                        <a href="member.php" class="card-link">Yeni Üye Ekle</a>
            ...
            <div class="col md-flex ">
                <div class="card2">
                    <a href="üyebilgi.php">
                    <img src="images/üyebilgi.jpg" class="card-img-top img-thumb-nail" id="photo" alt="">
                    </a>
                     <div class="card-body">
                     <a href="üyebilgi.php" class="card-link ">Üye Bilgilerini Göster</a>
