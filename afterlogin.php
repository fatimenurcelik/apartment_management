         ...
         <div class="jumbotron bg-dark text-white">
             <div class="container">
                 <div class="col-md-6">
                     ...
                     <br>
                     <p class="lead mb-6">
                     7/24 tam güvenlik sisteminin denetiminde kamera gözetimiyle korunan 
                     ÇINAR APARTMANINDA kendinizi ve ailenizi daima güvende hissedeceksiniz.
                     Her daireye özel 1 adet kapalı otopark ile aklınız aracınızda kalmayacak.
                     </p>
                     <h5 class="col-md-6">
                         DOĞRU YATIRIM
                    </h5>
                    <p class="lead md-3">
                    Sehrin en güzel lokasyonunda her geçen gün değeri katlanarak
                     artan altın değerinde bir yatırım fırsatı. 
                    </p>
                 </div>
             </div>
         </div> 
                    ...
                    <div class="card-body">
                        <h4 class="card-title">Temizlik hizmeti</h4>
                         <p>
                            ...
                            cumque asperiores odit accusantium atque ratione nam, neque, impedit,
                            sit consequuntur eum cum incidunt. Quos harum corporis maxime eaque dolores.
                        </p>
                    </div>
                   </div>
